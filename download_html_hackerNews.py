...
"""
Function:
    1. Download the Hacker News homepage HTML.
...
I/O:
    ...
    2. Output:
        2.1 HTML file of the Hacker News homepage (html file)
...
if __name__ == "__main__":
    ...
    hacker_news_homepage_url = "https://thehackernews.com/"
    hacker_news_html_path = f"./Data/hacker_news_{today_str}.html"
    download_html(hacker_news_homepage_url, hacker_news_html_path)
